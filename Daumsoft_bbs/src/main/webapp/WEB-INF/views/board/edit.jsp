...
<body>
<div id="info">게시글 수정</div>
<div id="bbs">
<form name="updateForm" method="post" action="/board/update">
   <div id="title_section">
     <input type="text" id="title" name="title" maxlength="25" placeholder="제목을 입력하세요" value="${dto.title}" />
   </div>
   <div id="contents_section">
     <textarea id="contents" name="contents">${dto.contents}</textarea>
   </div>
   <div id="writer_section">
     <input type="text" id="writer" name="writer" size="10" placeholder="이름을 입력하세요" maxlength="8" value="${dto.writer}" />
   </div>
   <div id="btn_section">
